...
import { X, FileText, Play, RotateCcw, Maximize2, Minimize2 } from 'lucide-react'
import { useChat } from 'ai/react'
import ReactMarkdown from 'react-markdown'
import remarkGfm from 'remark-gfm'

const TABS = ['Roadmap Document', 'Task Breakdown', 'Project Step-by-Step']

export default function ProjectGeneratorPanel({ onClose }: { onClose: () => void }) {
  ...
  const getActiveChat = () => {
    ...
    if (activeTab === 'Task Breakdown') return taskBreakdownChat
    return stepByStepChat
  }
            ...
            <>
              ...
              <div className="flex flex-col gap-2 flex-1">
                ...
                <textarea
                  ...
                  placeholder={`Describe your project here to generate a ${activeTab}...`}
