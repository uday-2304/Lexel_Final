...
import { X, Search, Play, RotateCcw, Maximize2, Minimize2 } from 'lucide-react'
import { useChat } from 'ai/react'
import ReactMarkdown from 'react-markdown'
import remarkGfm from 'remark-gfm'

const TABS = ['Repository Analysis']

export default function RepositoryAnalyzerPanel({ onClose }: { onClose: () => void }) {
            ...
            <>
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 flex gap-3 shrink-0">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-sm font-semibold text-white">Repository Insights</span>
                  <span className="text-xs text-blue-200/70 leading-relaxed">
                    Analyze tech stacks, code quality, and architecture from any repository link.
                  </span>
                </div>
              </div>
